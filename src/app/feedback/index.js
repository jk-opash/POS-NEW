...
import { Menu, MessageSquare, Star, ThumbsDown, ThumbsUp } from "lucide-react-native";
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.filterRow}>
          {["All", "Positive", "Negative"].map((f) => (
            ...
            >
              <Text weight={activeFilter === f ? "semibold" : "regular"} style={[styles.filterTabText, activeFilter === f && styles.filterTabTextActive]}>{f}</Text>
            </TouchableOpacity>
          ))}
        </View>
        ...
        {filtered.map((fb) => (
          <View key={fb.id} style={styles.feedbackCard}>
            <View style={styles.feedbackHeader}>
              ...
              <View style={styles.feedbackRating}>{renderStars(fb.overall)}</View>
            </View>
