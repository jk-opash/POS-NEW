...
export default function OnlineOrderConfigPage() {
  ...
  const handleSaveConfig = () => {
    if (selectedPlatform) {
      updatePlatform(selectedPlatform.id, { storeId, apiKey, autoAccept });
    }
        ...
        <View style={styles.sectionHeaderRow}>
          <View>
            ...
            <Text style={styles.sectionSubtitle}>
              Connect and manage third-party delivery platforms.
            </Text>
          </View>
        </View>
            ...
            <View key={platform.id} style={styles.platformCard}>
              <View style={styles.cardHeader}>
                ...
                <Switch
                  ...
                  onValueChange={() =>
                    togglePlatformActive(platform.id, platform.isActive)
                  }
                  style={{ transform: [{ scaleX: 0.9 }, { scaleY: 0.9 }] }}
                />
              </View>
              <View style={styles.cardBody}>
                <Text weight="bold" style={styles.platformName}>
                  {platform.name}
                </Text>
              ...
              <View style={styles.cardFooter}>
                ...
                >
                  ...
                  <Text weight="medium" style={styles.configBtnText}>
                    Configure
                  </Text>
                </TouchableOpacity>
              </View>
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalHeader}>
              <View style={styles.modalHeaderLeft}>
                <Globe
                  size={20}
                  color={selectedPlatform?.themeColor || ThemeColors.primary}
                />
              ...
              <View style={styles.settingCard}>
                <View style={styles.settingContent}>
                  ...
                  <Text style={styles.settingDesc}>
                    Automatically accept and print KOTs when an order arrives
                    from this platform.
                  </Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  scrollContent: { padding: ThemeSpacing.xxl, paddingBottom: 100 },
  sectionHeaderRow: { marginBottom: ThemeSpacing.xl },
  sectionTitle: {
    fontSize: 20,
    color: ThemeColors.textPrimary,
    marginBottom: 4,
  },
  sectionSubtitle: { fontSize: 14, color: ThemeColors.textSecondary },
  grid: { flexDirection: "row", flexWrap: "wrap", gap: ThemeSpacing.xl },
  ...
  platformIconText: { color: ThemeColors.white, fontSize: 22 },
  cardBody: { marginBottom: ThemeSpacing.lg },
  platformName: {
    fontSize: 18,
    color: ThemeColors.textPrimary,
    marginBottom: 2,
  },
  platformStatus: { fontSize: 13, color: ThemeColors.textSecondary },
  cardFooter: {
    borderTopWidth: 1,
  ...
  configBtnText: { fontSize: 13, color: ThemeColors.textSecondary },
  modalOverlay: {
    flex: 1,
  ...
  modalTitle: { fontSize: 18, color: ThemeColors.textPrimary },
  closeBtn: {
    padding: 4,
    backgroundColor: ThemeColors.bg,
    borderRadius: ThemeRadius.full,
  },
  modalBody: { padding: ThemeSpacing.xl, gap: ThemeSpacing.xl },
  inputGroup: { gap: 8 },
  label: { fontSize: 14, color: ThemeColors.textPrimary },
  inputWrap: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: ThemeColors.bg,
  ...
  inputIcon: { marginRight: ThemeSpacing.sm },
  input: {
    flex: 1,
    fontSize: 14,
    color: ThemeColors.textPrimary,
  ...
  settingContent: { flex: 1, paddingRight: ThemeSpacing.lg },
  settingLabel: {
    fontSize: 15,
    color: ThemeColors.textPrimary,
    marginBottom: 2,
  ...
  cancelText: { fontSize: 14, color: ThemeColors.textSecondary },
  saveBtn: {
  ...
  saveText: { fontSize: 14, color: ThemeColors.white },
});
