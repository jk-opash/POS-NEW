...
export function RestaurantSettings({ settings, updateSetting }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.headerSubtitle}>
        Manage dining types, service charges, and kitchen workflows.
      </Text>
      ...
      <View style={styles.card}>
        <SettingsRow>
          <View style={styles.fieldGroup}>
            ...
            <TextInput
              ...
              onChangeText={(t) =>
                handleChange("serviceCharge", parseFloat(t) || 0)
              }
            />
          </View>
          <View style={styles.fieldGroup}>
            ...
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(t) =>
                handleChange("defaultTipPercentage", parseFloat(t) || 0)
              }
            />
          </View>
        </SettingsRow>
        ...
        <View style={styles.fieldGroup}>
          <Text style={styles.label}>
            Active Dining Modes (Comma Separated)
          </Text>
          <TextInput
            style={styles.input}
        ...
        <View style={styles.fieldGroup}>
          ...
          <View style={styles.switchRow}>
            <Text style={styles.switchRowText}>
              Use interactive floor plan for Dine-In
            </Text>
            <Switch
        ...
        <View style={styles.fieldGroup}>
          ...
          <View style={styles.switchRow}>
            <Text style={styles.switchRowText}>
              Send orders directly to Kitchen Display System
            </Text>
            <Switch
