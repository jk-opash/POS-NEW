...
export function ReceiptInvoiceSettings({ settings, updateSetting }) {
  const { receipt, invoice } = settings;

  const handleReceiptChange = (key, value) =>
    updateSetting("receipt", key, value);
  const handleInvoiceChange = (key, value) =>
    updateSetting("invoice", key, value);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.headerSubtitle}>
        Configure printed and digital receipt formats.
      </Text>
      ...
      <View style={styles.card}>
        ...
        <Text
          weight="bold"
          style={{ fontSize: 16, color: ThemeColors.white, marginTop: 12 }}
        >
          Print Toggles
        </Text>
          ...
          <View style={styles.fieldGroup}>
            <View style={styles.switchRow}>
              ...
              <Switch
                ...
                onValueChange={(v) => handleReceiptChange("showTax", v)}
              />
            </View>
          </View>
          <View style={styles.fieldGroup}>
            <View style={styles.switchRow}>
              ...
              <Switch
                value={receipt.printLogo}
                onValueChange={(v) => handleReceiptChange("printLogo", v)}
              />
            </View>
          </View>
        </SettingsRow>
        ...
        <SettingsRow>
          <View style={styles.fieldGroup}>
            <View style={styles.switchRow}>
              ...
              <Switch
                value={receipt.showCashierName}
                onValueChange={(v) => handleReceiptChange("showCashierName", v)}
              />
            </View>
          </View>
          <View style={styles.fieldGroup}>
            <View style={styles.switchRow}>
              ...
              <Switch
                value={receipt.barcodeEnabled}
                onValueChange={(v) => handleReceiptChange("barcodeEnabled", v)}
              />
            </View>
          </View>
        </SettingsRow>
      ...
      <Text weight="bold" style={[styles.headerTitle, { marginTop: 32 }]}>
        Invoice Settings
      </Text>
        ...
        <SettingsRow>
          ...
          <View style={styles.fieldGroup}>
            ...
            <TextInput
              ...
              onChangeText={(t) =>
                handleInvoiceChange("dueDays", parseInt(t) || 0)
              }
            />
          </View>
        </SettingsRow>
