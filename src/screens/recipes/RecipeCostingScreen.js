...
import { Beaker, ChevronRight, IndianRupee, Menu, Percent, Plus, Search } from "lucide-react-native";
...
const MOCK_RECIPES = [
  { id: "R-001", menuItem: "Paneer Butter Masala", category: "Main Course", foodCost: 100, sellingPrice: 300, margin: 66.7, ingredients: [
    { name: "Paneer", qty: "200g", cost: 40 },
    { name: "Tomato Puree", qty: "150ml", cost: 15 },
    { name: "Cream", qty: "50ml", cost: 20 },
    { name: "Butter", qty: "30g", cost: 12 },
    { name: "Spices Mix", qty: "10g", cost: 8 },
    { name: "Kasuri Methi", qty: "2g", cost: 5 },
  ]},
  { id: "R-002", menuItem: "Butter Chicken", category: "Main Course", foodCost: 130, sellingPrice: 350, margin: 62.9, ingredients: [
    { name: "Chicken", qty: "250g", cost: 55 },
    { name: "Tomato Puree", qty: "200ml", cost: 20 },
    { name: "Cream", qty: "60ml", cost: 25 },
    { name: "Butter", qty: "40g", cost: 16 },
    { name: "Yogurt", qty: "50g", cost: 8 },
    { name: "Spices Mix", qty: "15g", cost: 6 },
  ]},
  { id: "R-003", menuItem: "Chicken Biryani", category: "Biryani & Rice", foodCost: 120, sellingPrice: 350, margin: 65.7, ingredients: [
    { name: "Chicken", qty: "250g", cost: 55 },
    { name: "Basmati Rice", qty: "200g", cost: 25 },
    { name: "Onion", qty: "100g", cost: 8 },
    { name: "Saffron", qty: "0.2g", cost: 15 },
    { name: "Ghee", qty: "30ml", cost: 12 },
    { name: "Spices", qty: "10g", cost: 5 },
  ]},
  { id: "R-004", menuItem: "Dal Makhani", category: "Main Course", foodCost: 70, sellingPrice: 260, margin: 73.1, ingredients: [
    { name: "Black Urad Dal", qty: "150g", cost: 18 },
    { name: "Rajma", qty: "50g", cost: 8 },
    { name: "Cream", qty: "40ml", cost: 18 },
    { name: "Butter", qty: "30g", cost: 12 },
    { name: "Tomato", qty: "100g", cost: 8 },
    { name: "Spices", qty: "8g", cost: 6 },
  ]},
  { id: "R-005", menuItem: "Masala Dosa", category: "South Indian", foodCost: 40, sellingPrice: 150, margin: 73.3, ingredients: [
    { name: "Dosa Batter", qty: "150ml", cost: 10 },
    { name: "Potato", qty: "150g", cost: 8 },
    { name: "Onion", qty: "50g", cost: 4 },
    { name: "Mustard Seeds", qty: "5g", cost: 2 },
    { name: "Sambar", qty: "100ml", cost: 10 },
    { name: "Chutney", qty: "50ml", cost: 6 },
  ]},
  { id: "R-006", menuItem: "Gulab Jamun (2 Pcs)", category: "Desserts", foodCost: 25, sellingPrice: 100, margin: 75.0, ingredients: [
    { name: "Khoya", qty: "80g", cost: 14 },
    { name: "Sugar", qty: "60g", cost: 4 },
    { name: "Cardamom", qty: "1g", cost: 3 },
    { name: "Rose Water", qty: "5ml", cost: 2 },
    { name: "Oil (frying)", qty: "20ml", cost: 2 },
  ]},
];

export function RecipeCostingScreen() {
  ...
  const filtered = MOCK_RECIPES.filter((r) =>
    r.menuItem.toLowerCase().includes(searchQuery.toLowerCase())
  );
    ...
    <View style={styles.root}>
      ...
      <View style={styles.statsRow}>
        <View style={styles.statCard}>
          ...
          <Text weight="bold" style={styles.statValue}>{MOCK_RECIPES.length}</Text>
        </View>
        <View style={styles.statCard}>
          <Text style={styles.statLabel}>Avg Food Cost</Text>
          <Text weight="bold" style={styles.statValue}>₹{avgFoodCost}</Text>
        </View>
        <View style={styles.statCard}>
          <Text style={styles.statLabel}>Avg Margin</Text>
          <Text weight="bold" style={[styles.statValue, { color: ThemeColors.emerald }]}>{avgMargin}%</Text>
        </View>
      </View>
      ...
      <View style={styles.body}>
        <ScrollView style={styles.recipeList} showsVerticalScrollIndicator={false}>
          {filtered.map((recipe) => (
            <TouchableOpacity
              key={recipe.id}
              style={[styles.recipeCard, selectedRecipe?.id === recipe.id && styles.recipeCardSelected]}
            ...
            >
              ...
              <View style={styles.recipeMetrics}>
                <View style={styles.metricBox}>
                  ...
                  <Text weight="semibold" style={styles.metricValue}>₹{recipe.foodCost}</Text>
                </View>
                <View style={styles.metricBox}>
                  <Text style={styles.metricLabel}>Price</Text>
                  <Text weight="semibold" style={styles.metricValue}>₹{recipe.sellingPrice}</Text>
                </View>
