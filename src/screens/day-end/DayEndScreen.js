      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          {SHIFT_SUMMARY.topItems.map((item, i) => (
            <View key={i} style={styles.topItemRow}>
              <View style={styles.topItemRank}>
                <Text weight="bold" style={styles.topItemRankText}>#{i + 1}</Text>
              </View>
        ...
        <View style={styles.reconciliation}>
          ...
          <View style={styles.reconRow}>
            <Text style={styles.reconLabel}>Opening Cash</Text>
            <Text weight="semibold" style={styles.reconValue}>₹{SHIFT_SUMMARY.openingCash}</Text>
          </View>
          <View style={styles.reconRow}>
            <Text style={styles.reconLabel}>Cash Sales</Text>
            <Text weight="semibold" style={styles.reconValue}>+₹{SHIFT_SUMMARY.payments.cash}</Text>
          </View>
          <View style={styles.reconRow}>
            <Text style={styles.reconLabel}>Refunds (Cash)</Text>
            <Text weight="semibold" style={[styles.reconValue, { color: ThemeColors.red }]}>-₹{SHIFT_SUMMARY.refunds}</Text>
          </View>
