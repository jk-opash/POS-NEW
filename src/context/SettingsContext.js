...
const DEFAULT_SETTINGS = {
  business: {
    ...
    regNumber: 'U55101GJ2023PTC123456',
    ...
    logoUrl: '',
    facebook: '@spicegarden',
    instagram: '@spicegarden_ahmedabad',
  },
  branch: {
    code: 'BR-001',
    manager: 'Rajesh Patel',
    status: 'Active',
    contactEmail: 'cg-road@spicegarden.in',
    contactPhone: '+91 79 2345 6789',
    openingHours: '11:00 AM - 11:00 PM',
    capacity: 80,
    features: ['AC Dining', 'Private Room', 'Rooftop'],
  },
  tax: {
    defaultRate: 5,
    inclusive: false,
  ...
  gst: {
    ...
    cessRate: 0,
    isInterState: false,
    hsnCodeDefault: '996331', // Restaurant services
  ...
  receipt: {
    header: 'Welcome to Spice Garden!',
    ...
    printLogo: true,
    barcodeEnabled: true,
    qrCodeUrl: 'https://spicegarden.in/feedback',
  ...
  invoice: {
    prefix: 'INV-',
    dueDays: 14,
    notes: 'GST compliant invoice. Thank you!',
    bankDetails: 'Bank: HDFC, A/C: 00123456789, IFSC: HDFC0001234',
    showHSNCode: true,
    showSAC: true,
  },
  payment: {
    ...
    roundingTo: 1, // Round to nearest ₹1
    defaultMethod: 'Cash',
    tipEnabled: true,
    defaultTipPercentages: [5, 10, 15],
  },
  discount: {
    maxPercentage: 20,
    ...
    buyXGetYEnabled: true,
    comboDealsEnabled: true,
  },
  inventory: {
    allowNegative: false,
    lowStockThreshold: 10,
    autoPurchaseOrders: false,
    defaultSupplier: 'Metro Cash & Carry',
    trackWaste: true,
  ...
  restaurant: {
    ...
    diningModes: ['Dine In', 'Takeaway', 'Delivery', 'Online'],
    ...
    onlineOrderTimer: 120, // seconds to accept
  },
  kot: {
    autoNumber: true,
    numberPrefix: 'KOT',
  ...
  qrOrdering: {
    enabled: true,
    menuStyle: 'grid', // 'grid' or 'list'
    allowPayment: false,
    showImages: true,
    showDescription: true,
    showVegFilter: true,
    requireTableScan: true,
    autoRouteToKDS: true,
  },
  dayEnd: {
    autoPromptClose: true,
    promptTime: '23:00',
    requireCashCount: true,
    requireManagerApproval: false,
    autoEmailReport: true,
    reportRecipients: ['manager@spicegarden.in'],
    printSummary: true,
  },
  feedback: {
    enabled: true,
  ...
  notification: {
    emailAlerts: true,
    lowStockAlerts: true,
    newOnlineOrderSound: true,
    feedbackAlerts: true,
    dayEndReminder: true,
    staffClockInAlert: false,
  },
  hardware: {
    defaultPrinter: 'Epson TM-T82II',
    kitchenPrinter: 'Epson TM-U220',
    cashDrawerEnabled: true,
    customerDisplayEnabled: false,
    barcodeScannerEnabled: true,
    weighingScalePort: '',
    kotPrinterStations: {
      'Main Kitchen': 'Kitchen Printer 1',
      'Tandoor': 'Kitchen Printer 2',
      'Bar': 'Bar Printer',
      'Desserts': 'Kitchen Printer 1',
    },
  },
  integration: {
    paymentProvider: 'Razorpay',
    accountingSync: 'Tally Prime',
...
export function SettingsProvider({ children }) {
  ...
  return (
    <SettingsContext.Provider value={{ settings, updateSetting, updateNestedSetting }}>
      {children}
